@extends("core")
@section('title', 'Privacy Policy - CodeBuilder, Inc.')
...
@section("content")
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-8">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title"><i class="fa fa-eye"></i> CodeBuilder.us Privacy Policy</h1>
    ...
    @if($ajax)
        <script type="text/javascript">
            document.title = "FAQ - CodeBuilder.us";
