@extends("core")
@section('title', 'Edit Invoice - CodeBuilder Inc.')
@section('description', 'Client Invoice.')
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="main col-md-12">
				<!-- page-title start -->
				<!-- ================ -->
				<h1 class="page-title"><i class="fa fa-qrcode"></i> Invoice #{{$invoice->identifier}} <a href="/invoice/{{$invoice->identifier}}" target="_blank"><i class="fa fa-external-link"></i></a></h1>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label>Client -  <small>(<strong>Note:</strong> If this is a new client you must <a href="/admin/client/new">create</a> it first</small>)</label>
							<input class="form-control input-sm" id="sheroes" placeholder="Type an existing client's name" type="text" name="client_name" value="{{$invoice->Client->name}} (#{{$invoice->Client->id}})"><span class="pmd-textfield-focused"></span>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control" name="project_id" id="project_select">
								@foreach($invoice->Client->Projects as $project) 
									<option value="{{$project->id}}" @if($project->id == $invoice->project_id) selected @endif>{{$project->title}}</option>
								@endforeach
							</select>
						</div>
					</div>
			...
			<div class="col-md-12">
					<div class="block clearfix">
						...
						<div id="line_items_wrapper">
							<div class="row" id="line_item_template" style="display: none;">
								<div class="col-md-1">
									<div class="form-group has-feedback">
		...
		<div class="row">
			<div class="col-md-12">
					<div class="block clearfix">
						<h3 class="title">
							<i class="fa fa-clock-o"></i> Time & Effort
						</h3>
						<div class="separator-2"></div>
						<div class="row">
